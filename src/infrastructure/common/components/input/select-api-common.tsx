...
const InputSelectAPICommon = (props: Props) => {
    const {
        dataAttribute,
        setData,
        attribute,
                    ...
                    >
                        {
                            listDataOfItem && listDataOfItem.length && listDataOfItem.map((item, index) => {
                                return (
                                    <Select.Option
                                        key={index}
                                        value={item[valueById || item.id]}
                                        title={item[valueByName || value]}
                                    >
                                        {item[valueByName || value]}
                                    </Select.Option>
                                )
                            })
                        }
...
export default InputSelectAPICommon;
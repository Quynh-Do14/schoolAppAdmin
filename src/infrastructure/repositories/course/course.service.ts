...
class CourseService {
    ...
    async getCourseById(id: string, setLoading: Function) {
        setLoading(true)
        try {
            return await RequestService
    ...
    async updateCourse(id: string, data: object, onBack: Function, setLoading: Function) {
        setLoading(true)
        try {
            return await RequestService
    ...
    async deleteCourse(id: string, setLoading: Function) {
        setLoading(true)
        try {
            return await RequestService

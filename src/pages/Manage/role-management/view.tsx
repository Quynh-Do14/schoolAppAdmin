...
const ViewRoleManagement = () => {
    ...
    const onUpdateCategoryAsync = async () => {
        ...
        if (isValidData()) {
            await roleService.updateRole(
                String(param.id),
                {
                    roleName: dataCategory.roleName,
                },
                onBack,
                setLoading
            )
    ...
    return (
        <ManageLayout breadcrumb={"Quản lý quyền"} title={"Xem chi tiết"} redirect={ROUTE_PATH.ROLE_MANAGEMENT}>
                            ...
                            <Row gutter={[30, 0]}>
                                <Col span={24}>
                                    <InputTextCommon
                                        ...
                                        attribute={"roleName"}
                                        isRequired={true}
                                        dataAttribute={dataCategory.roleName}
